			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				if (actionEvent.getSource() == view.getSubmitToGitHubButton()) {
					...
					if (gitHubLoginname == null || gitHubPassword == null
						...
						view.setGithubInforSaveMsgTextArea("Need GitHub loginname and password beferore committing files!");
						...
						view.setGithubInforSaveMsgTextArea("Need \"Build and preview\" beferore committing files!");
						...
						try {
							addResult = clientA.addFile("output1.xml",
									...
									"master", "Submit " + "output1"
											+ " to source");
							view.setGithubInforSaveMsgTextArea(addResult.toString());
							...
							addResult2 = clientA
									.addFile("output2.xml", "targetoutcome/"
											...
											"master", "Submit " + "output2"
													+ " to targetoutcome");
							view.setGithubInforSaveMsgTextArea(addResult2.toString());

						} catch (Exception e1) {
							view.setGithubInforSaveMsgTextArea(e1.toString());
							good = false;
							e1.printStackTrace();
						}
						...
						try {
							file = clientA.getFile("testglossaryfixed.csv",
									"master");
							view.setGithubInforSaveMsgTextArea(file.getAbsolutePath() + " "
									+ file.exists());
						...
						try {
							addResult3 = clientA.addFile(
									...
									"Submit " + "testglossaryfixed.csv"
											+ " to testcases folder");
							view.setGithubInforSaveMsgTextArea(addResult3.toString());
						} catch (Exception e1) {
							view.setGithubInforSaveMsgTextArea(e1.toString());
							good = false;
							e1.printStackTrace();
				...
				if(good) view.setGithubInforSaveMsgTextArea("test case submitted");
				// sampleAction();
